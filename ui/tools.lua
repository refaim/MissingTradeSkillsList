...
-- returns              Frame       Returns the created frame
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateMainFrame(name_parent_class, name, width, height, swap_frames)
...
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateCheckbox(owner, name, margin_left, margin_top)
...
----------------------------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateIconTextButton(event_class, name, nr_in_list, btn_width, btn_height)
...
-- returns              Frame       Returns the created frame
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateScrollFrame(parent_class, parent_frame, width, height, has_backdrop, height_slider_step)
...
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:PrintAboutMessage()
...
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:PrintHelpMessage()
...
function MTSLUI_TOOLS:SetAddonLocale()
...
------------------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateWayPoint(waypointinfo, item_name)
...
-- returns              Frame       Returns the created frame
----------------------------------------------------------------------------------------
function MTSLUI_TOOLS:CreateDropDown(name, frame_owner, point_owner, point_anchor, margin_left, margin_top, initialiser, width_dd)
...
------------------------------------------------------------------------------------------------
function MTSLUI_TOOLS:FillDropDown(values, change_handler, change_frame_name)
    local info = {}
    -- add all values
...
------------------------------------------------------------------------------------------------
function MTSLUI_TOOLS:FillDropDownCheckable(values, change_handler, change_frame_name)
    local info = {}
...
function MTSLUI_TOOLS:AddDragToFrame(frame_to_drag)
...
function MTSLUI_TOOLS:GetLocalisedLabel(label)
...
function MTSLUI_TOOLS:GetLocalisedLabelSpecialAction(label)
    if MTSLUI_CURRENT_LANGUAGE == nil then MTSLUI_CURRENT_LANGUAGE = "English" end
...
------------------------------------------------------------------------------------------------
function MTSLUI_TOOLS:GetLocalisedData(data)
